...
private suspend fun jsoupFetchCourseList(studentNumber: String, password: String, raw: Boolean, timing: Timing, forceUseProxy: Boolean) =
    site.pegasis.ta.fetch.fetchdata.jsoup.LoginPage(JsoupSession(forceUseProxy), timing)
...
suspend fun fetchUserCourseList(studentNumber: String,
                                ...
                                forceUseProxy: Boolean = false): CourseList {
