...
import site.pegasis.ta.fetch.tools.round
import site.pegasis.ta.fetch.tools.toJSONString

object TimeLineSerializerV4 {
    private fun serializeAssignmentAdded(assignmentAdded: AssignmentAdded): JSONObject {
        ...
        obj["overall_before"] = assignmentAdded.overallBefore?.round(1)
        obj["overall_after"] = assignmentAdded.overallAfter.round(1)
